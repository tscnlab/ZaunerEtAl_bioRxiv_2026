...
stopifnot(
  ...
  nrow(first_build$data$glasses_participant_day_context) == 811L,
  nrow(first_build$data$chest_participant_day_context) == 897L,
  nrow(first_build$data$glasses_participant) == 141L,
  nrow(first_build$data$chest_participant) == 154L,
  nrow(first_build$data$glasses_30_minute_context) == 38928L,
  nrow(first_build$data$chest_30_minute_context) == 43056L,
  nrow(first_build$data$glasses_one_hour_context) == 19464L,
  nrow(first_build$data$chest_one_hour_context) == 21528L,
