  ...
  primary_publication_summary |>
    ...
    transmute(
      ...
      `Exact fitted sample` = paste0(
        as.integer(.data$participants), " participants; ",
        as.integer(.data$participant_days), " participant-days; ",
        as.integer(.data$observations), " observations; ",
        as.integer(.data$sites), " sites"
      )
    )
}
    ...
    tab_source_note(
      md(
        paste0(
          ...
          "statistics remain in the detailed tables below."
        )
      )
    )
}
...
#| tbl-cap: "Publication summary of the primary near-eye H01 results."
...
![Primary near-eye site differences or ratios relative to the equally weighted overall site mean. Only metrics with a supported overall site test are shown; horizontal lines are 95% confidence intervals.](../../artifacts/10_figures/H01/stage3/H01_stage3_site_contrasts_near_eye.png){#fig-h01-site-contrasts-near-eye fig-alt="Faceted forest plots for the eight near-eye metrics with a supported overall site test. Each panel displays the nine study sites in registered north-to-south order, with coloured points and horizontal 95 percent confidence intervals around differences or ratios relative to the equally weighted site mean. Dashed vertical lines mark zero for differences and one for ratios." width="100%"}
...
![Complementary chest site differences or ratios relative to the equally weighted overall site mean. Only metrics with a supported overall site test are shown; horizontal lines are 95% confidence intervals.](../../artifacts/10_figures/H01/stage3/H01_stage3_site_contrasts_chest.png){#fig-h01-site-contrasts-chest fig-alt="Faceted forest plots for the 13 chest metrics with a supported overall site test. Each panel displays the available study sites in registered north-to-south order, with coloured points and horizontal 95 percent confidence intervals around differences or ratios relative to the equally weighted site mean. Dashed vertical lines mark zero for differences and one for ratios." width="100%"}
