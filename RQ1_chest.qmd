---
title: "Research Question 1 - chest analysis"
...
This document contains the analysis for Research Question 1, as defined in the [preregistration](	https://aspredicted.org/te3zw2.pdf), for the chest-level data
...
melidos_colors <- melidos_colors[-5]
melidos_order <- melidos_order[-4]
H1_tab <- 
...
H1_tab 
gtsave(H1_tab, "tables/chest/H1.png", vwidth = 2000)
save(metrics, file = "data/H1_results_chest.RData")
```
...
```{r}
R2_tbl
gtsave(R2_tbl, "tables/chest/H1_R2_tbl.png")
```
...
ggsave("figures/chest/Fig4.pdf", height = 17, width = 13)
ggsave("figures/chest/Fig4.png", height = 17, width = 13)
