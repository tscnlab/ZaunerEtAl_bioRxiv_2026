...
writeLines(c("Structural/protected-content checks only. No scientific recomputation. Visual review is recorded separately.",
             "Command: RENV_CONFIG_AUTOLOADER_ENABLED=FALSE R_LIBS_USER=/Users/zauner/Library/R/arm64/4.6/library Rscript --vanilla audit/manuscript_nature_health/revision_2026_09_11/consolidated_display_repair_order72k/s2_accessibility_guard_recovery_001/reconcile_capture_verified.R",
