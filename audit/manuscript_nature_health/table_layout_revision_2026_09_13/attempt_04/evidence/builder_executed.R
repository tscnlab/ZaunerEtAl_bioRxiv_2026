...
t2_widths <- c(176,254,230,180,180,200,100)
...
stopifnot(identical(cum$new_text[k[1]],oldblock),grepl(oldref,cum$new_text[k[2]],fixed=TRUE))
cum$new_text[k[1]] <- newblock
