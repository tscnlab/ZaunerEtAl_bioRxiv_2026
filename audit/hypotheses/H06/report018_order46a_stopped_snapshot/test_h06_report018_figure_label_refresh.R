...
assert_true(
  identical(
    vapply(protected_paths, sha256_file, character(1)),
    protected$sha256
  ) &&
    identical(vapply(protected_paths, file_bytes, numeric(1)), protected$bytes),
...
assert_true(
  identical(
    vapply(owner_paths, sha256_file, character(1)),
    owner_manifest$sha256
  ) &&
    identical(
      vapply(owner_paths, file_bytes, numeric(1)),
