...
j <- 'audit/report_harmonization/final_site_reader_cleanup_2026_09_14'
evidence <- Sys.getenv('ORDER017_EVIDENCE',file.path(j,'evidence'))
candidate <- Sys.getenv('ORDER017_SITE_ROOT',file.path(j,'candidate_build'))
