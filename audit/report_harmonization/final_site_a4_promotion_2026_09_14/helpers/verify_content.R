...
out <- file.path(root, "audit/report_harmonization/final_site_a4_promotion_2026_09_14")
evidence <- Sys.getenv("ORDER016_EVIDENCE", file.path(out, "evidence"))
...
candidate <- Sys.getenv("ORDER016_SITE_ROOT", file.path(root, "_build/nathealth"))
options(warn=2)
checks <- list()
