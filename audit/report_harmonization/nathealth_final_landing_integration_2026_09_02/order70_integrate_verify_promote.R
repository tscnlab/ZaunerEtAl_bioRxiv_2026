...
# Bounded, no-render implementation for REPORT-018 Orders 70, 70a, and 70b.
...
script_path <- file.path(evidence_dir, "order70_integrate_verify_promote.R")
...
validate_browser_evidence <- function(prefix) {
  ...
  stopifnot(
    ...
    setequal(unique(route_qa$width), c(390L, 708L)),
    all(route_qa$pass),
