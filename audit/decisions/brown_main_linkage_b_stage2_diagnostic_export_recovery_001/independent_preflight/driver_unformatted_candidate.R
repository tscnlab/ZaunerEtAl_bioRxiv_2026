...
registry_root <- file.path(stage2_root, "preflight/diagnostic_export_recovery_001")
...
driver_path <- file.path(code_root, "07_run_primary_diagnostics_v2.R")
...
technical <- data.frame(
  ...
  status = as.character(result$bundle$fit_gate$fit_status),
