...
brief <- paste0(
  ...
  "- **Within participants, exploratory:** Per 10 pp higher-than-usual Daytime adherence, the adjusted differences were ",
  ...
  "- **Between participants, exploratory:** Per 10 pp higher observed average Daytime adherence, the adjusted differences were ",
  assoc_inline("between_sleep"),
  " for Sleep and ",
  assoc_inline("between_pre_sleep"),
  " for Pre-sleep. Both intervals exclude zero and both tests met the separate four-effect false-discovery-rate (FDR) threshold. These are limited observational associations over the monitoring period.\n\n",
...
write.csv(
  data.frame(
    check = c(
      "14_exact_changes",
      "byte_exact_reverse",
      "R_AST_except_four_display_strings",
