...
The [reader results](../../13_cross_state_association_results_amendment.qmd#sec-brown-main-results) and [preparation companion](../../14_cross_state_association_preparation_and_provenance.qmd#sec-purpose) use the complete main package with exact reuse of the separate exploratory extension. Writer and shared-page propagation remain separate.
...
![Current site Work-Free differences: diamonds compare with zero; asterisks compare with the equal-site effect.](../stage3/figures/main_site_free_work.png){#fig-implementation-free-work fig-alt="All 27 site effects and CIs with distinct against-zero and departure-from-average markers." width="100%"}
